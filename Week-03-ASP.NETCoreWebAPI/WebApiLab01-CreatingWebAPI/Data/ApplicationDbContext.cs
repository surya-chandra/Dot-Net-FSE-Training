...
namespace WebApiLab01.Data;

/// <summary>
/// EF Core DbContext for the Retail Inventory System.
/// Registered in Program.cs via AddDbContext().
/// </summary>
public class ApplicationDbContext : DbContext
{
    // Constructor accepts options injected by the DI container.
    // This is the standard pattern for Web API projects —
    // the connection string comes from appsettings.json, not OnConfiguring().
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        // Seed initial data so the API has records to return immediately
    ...
    private static void SeedData(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Category>().HasData(
            ...
            new Category { Id = 3, Name = "Sports",        Description = "Sports equipment and outdoor gear" }
        );
        ...
        modelBuilder.Entity<Product>().HasData(
            ...
            new Product { Id = 4, Name = "Running Shoes",       Price =   79.99m, StockQuantity = 100, CategoryId = 2, SupplierId = 2 },
            new Product { Id = 5, Name = "Yoga Mat",            Price =   24.99m, StockQuantity = 120, CategoryId = 3, SupplierId = 3 }
        );
    }
}
